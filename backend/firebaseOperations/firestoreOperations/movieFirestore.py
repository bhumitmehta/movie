...
__all__ = ['get_movies_all', 'get_movie_by_id', 'add_movie_db', 'delete_movie_db', 'get_carousels', 'get_movies_json']
...
def get_movie_by_id(document_id, jsonType=False):
    movie = None
...
def get_carousels():
    ...
    (day, month, year) = (date.day, (date.month + 10) % 12 + 1, date.year + (date.month - 60) // 12)
